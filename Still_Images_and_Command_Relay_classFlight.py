...
class main:
    ...
    def __init__(self):
        ...
        self.testString = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz1234567890-=!@#$%^&*()_+~`,./[]<>?:"{}|\n'
    ...
    def loop(self):
        ...
        try:
            ...
            if(self.rfdEnabled):
                ...
                # Send the test string periodically
                if (time.time() - self.testTime) > 60:
                    self.ser.write(self.testString)
